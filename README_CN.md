...
回测区间为 2021-01-01 至 2023-12-31，基准指数为沪深300。
...
从回测结果看，策略在 2021-2023 年实现了 15.94% 的累计收益（年化 5.27%），同期沪深300累计下跌 34.16%，策略相对基准取得了 74.57% 的超额累计收益，年化超额收益达 21.33%，信息比率为 0.79，月度胜率 54.29%。这说明在市场整体下行的样本区间内，多因子选股组合不仅实现了正收益，还展现出较强的超额收益获取能力。需要注意的是，策略最大回撤为 -43.42%、年化波动率 33.10%，绝对风险水平仍然偏高，夏普比率 0.07 反映出绝对收益相对于波动的性价比有限，后续可在风险控制和回撤管理上进一步优化。
